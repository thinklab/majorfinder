...
INSTITUTION_FILE = os.path.join(BASE_DIR, "data", "raw", "cohorts_institutions.csv")
FOS_FILE = os.path.join(BASE_DIR, "data", "raw", "recent-cohorts-filed.csv")
OUTPUT_FILE = os.path.join(BASE_DIR, "data", "clean", "clean_data.csv")
